...
function checkBrowser() {
  try {
    ...
    runningElem.innerHTML = "Your browser may not support gamepads in an insecure context!";
  }
}
...
function onOpen(event) {
  ...
  websocket.send('WS Connection Opened');
}
...
function process() {
  ...
  Object.values(gamepadsByIndex).forEach(processInputs);
